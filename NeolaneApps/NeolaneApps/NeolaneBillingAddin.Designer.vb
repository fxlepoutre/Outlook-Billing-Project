...
Partial Public NotInheritable Class NeolaneBillingAddin
    ...
    Protected Overrides Sub Initialize()
        ...
        Globals.NeolaneBillingAddin = Me
...
Partial Friend NotInheritable Class Globals
    ...
    Private Shared _NeolaneBillingAddin As NeolaneBillingAddin
    ...
    Friend Shared Property NeolaneBillingAddin() As NeolaneBillingAddin
        Get
            Return _NeolaneBillingAddin
        End Get
        Set(ByVal value As NeolaneBillingAddin)
            If (_NeolaneBillingAddin Is Nothing) Then
                _NeolaneBillingAddin = value
            Else
    ...
    Friend Shared ReadOnly Property FormRegions() As ThisFormRegionCollection
        Get
            If (_ThisFormRegionCollection Is Nothing) Then
                _ThisFormRegionCollection = New ThisFormRegionCollection(Globals.NeolaneBillingAddin.GetFormRegions)
            End If
...
Partial Friend NotInheritable Class ThisFormRegionCollection
    ...
    Default Friend Overloads ReadOnly Property Item(ByVal explorer As Microsoft.Office.Interop.Outlook.Explorer) As WindowFormRegionCollection
        Get
            Return CType(Globals.NeolaneBillingAddin.GetFormRegions(explorer, GetType(WindowFormRegionCollection)), WindowFormRegionCollection)
        End Get
    End Property
    ...
    Default Friend Overloads ReadOnly Property Item(ByVal inspector As Microsoft.Office.Interop.Outlook.Inspector) As WindowFormRegionCollection
        Get
            Return CType(Globals.NeolaneBillingAddin.GetFormRegions(inspector, GetType(WindowFormRegionCollection)), WindowFormRegionCollection)
        End Get
    End Property
End Class
